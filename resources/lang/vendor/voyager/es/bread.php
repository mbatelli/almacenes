...
return [
    ...
    'order'                  => 'Orden',
    'order_column'           => 'Columna orden',
    'order_column_ph'        => 'La columna donde el orden está almacenado',
    'order_ident_column'     => 'Columna que muestra el orden',
    'order_ident_column_ph'  => 'La columna que se muestra en la página de orden',
    'ordering_not_set'       => 'Debe definir el ordenamiento primero',
